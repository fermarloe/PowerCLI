####################### 
#	Script Name:		vSphere-Functions-v1.2.ps1
#	Description:		Functions for intern service script for VMware environments 
#	Data:				23/Dec/2019
#	Version:			1.2
...
#                       20191223 - 1.2  Remved old commented code lines
#
#######################
